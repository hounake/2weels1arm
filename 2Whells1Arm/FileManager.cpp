...
//				//<< "," << robot.getShoulder().second // TODO : utilise la liste a la place
//				<< endl;
//		}
//	}
//
...
//			//robot.setShoulder(pair<simxInt, simxInt>(stoi(robot_datas[7]), stoi(robot_datas[8]))); // TODO : utiliser la liste a la place
//			
